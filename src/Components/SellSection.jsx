...
// <div className="w-full h-screen bg-gradient-to-tr from-black to-gray-700">
//   <img
//     src={image}
//     alt="bg"
//     className="w-full h-screen object-cover absolute mix-blend-overlay"
//   />
//   <div className="z-5 w-full h-full flex justify-center items-center">
//     <div className="max-w-same flex flex-col justify-center text-gray-100">
//       <div className="">
...
//           facilis at aperiam ab ratione corporis molestias. Quae eveniet totam
//           quibusdam? Possimus, iusto nobis quo mollitia minima
//         </p>
//       </div>
...
//           >
//             <span className="cursor-pointer block text-gray-100  px-16 py-2 font-semibold bg-gray-800 uppercase">
//               Sell
//             </span>
//           </button>
//         </Link>
